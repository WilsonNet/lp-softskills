...
function Meat() {
  return (
    <main className="">
      <div>
        <div className="text-3xl">O que é você??</div>
        <h1 className="text-9xl uppercase">Resilência</h1>
        <div>A soft skill da coisa</div>
      </div>
      <div>
      ...
      <div>
        <blockquote>
          <span>física</span>
          <div>
            propriedade que alguns corpos apresentam de retornar à forma
          </div>
        </blockquote>
        original após terem sido submetidos a uma deformação elástica. 2.
        figurado (sentido)•figuradamente capacidade de se recobrar facilmente ou
        se adaptar à má sorte ou às mudanças. Origem ⊙ ETIM ing. resilience
        'elasticidade' Traduzir resiliencia para o Definições de Oxford
        Languages
      </div>
